...
.right-column[
A continuous-time .alert[**compartmental**] approach: track node densities with $j$ agreeing neighbors nad $k$ disagreeing neighbors, for each combination of $k$ and $j$.
...
Plenty of room to define new, interesting models and analysis techniques. 
